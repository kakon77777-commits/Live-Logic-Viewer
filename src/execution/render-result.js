...
export function renderExecutionResult(root,envelope) {
  ...
  const provenance=document.createElement('details');const summary=document.createElement('summary');summary.textContent='Provenance hashes';provenance.append(summary,row('Request SHA-256',envelope.provenance.request_sha256),row('Source SHA-256',envelope.provenance.source_sha256))
